...
import { useGetSingleDataMutation, useUpdateUserMutation, useDeleteUserMutation } from "../../redux/api";
...
function Update() {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            //     `http://localhost:8000/update/edit/${userID}`,
            //     data
            // );
    ...
    // axios.post(
    //     `http://localhost:8000/update/delete/${userID}`
    // );
        ...
        <div className="container mt-3">
            ...
            <form onSubmit={handleSubmit(onSubmit)} id="registration-form">
                ...
                <div className="form-group mt-3">
                    ...
                    <div className="btn btn-danger" onClick={() => handleDelete(id)}>Delete</div>
                </div>
            </form>
